      ...
      <div className="container py-5">
        <div className="section-header text-center">
          ...
          <p>
            ...
            fellowship, and encourage spiritual growth. From worship gatherings
            to special programs, there’s always something happening for
            everyone. Stay connected and be part of what God is doing.
          </p>
        </div>

        {/* 🔥 1. Loading State */}

        {isLoading && <DashboardSkeleton variant="list" />}
